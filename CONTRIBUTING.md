...
Discussion of this work occurs on the [Routing Area Working Group
Working Group mailing list](mailto:rtgwg@ietf.org)
([archive](https://mailarchive.ietf.org/arch/browse/rtgwg/),
[subscribe](https://www.ietf.org/mailman/listinfo/rtgwg)).
...
[Working Group documents](https://datatracker.ietf.org/wg/rtgwg/documents/).
